...
class DiagnosaLanjutScreen extends StatefulWidget {
  const DiagnosaLanjutScreen({super.key});

  @override
  State<DiagnosaLanjutScreen> createState() => _DiagnosaLanjutScreenState();
}

class _DiagnosaLanjutScreenState extends State<DiagnosaLanjutScreen> {
  ...
  void _sendData() async {
    ...
    try {
      Response response = await dio(token: authProvider.token).post('diagnosa-lanjut', data: data);
